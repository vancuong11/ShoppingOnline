...
<body class="sb-nav-fixed">
	...
	<div id="layoutSidenav">
			...
			<nav class="sb-sidenav accordion sb-sidenav-dark"
				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						</a> <a class="nav-link" href="/account/login">
							<div class="sb-nav-link-icon">
								<i class="fas fa-table"></i>
							</div> Logout
						</a>
		...
		<div id="layoutSidenav_content">
			<main>
			<h3 class="text-center text-uppercase font-weight-bold">Products</h3>
					...
					<table class="table">
						...
						<c:forEach var="i" items="${page.content}">
							<tr>
								...
								<td>${i.price}</td>
								<td>${i.createDate}</td>
								<td><img style="width: 60px; height: 60px" alt="img"
									src="/img/${i.image}"></td>
								<td>${i.dicription}</td>
								<td>${i.available}</td>
								<td><a class="btn btn-primary" href="/product/edit/${i.id}"><i
										class="fas fa-edit"></i> </a>| <a href="/product/delete/${i.id}"
						...
						<nav aria-label="Page navigation example text-center ">
							<ul class="pagination justify-content-center">
								<li class="page-item "${ p==0?'disabled':''}><a 
									class="page-link " href="/product/index/?p=${page.number-1}"
									aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
										<span class="sr-only">Previous</span>
								</a></li>
								<li class="page-item" ${p == page.totalPages -1?'disabled':''}>
									<a class="page-link " href="/product/index/?p=${page.number+1}"
				...
				<div class="tab-pane fade" id="nav-profile" role="tabpanel"
					...
					<form:form action="/product/index" modelAttribute="item"
						...
						<div class="form-group ml-3">
							...
							<%-- <img style="width: 90px;height: 90px;" alt="" src="/images/${item.image}"> --%>
							<input name="img" type="file" class="form-control "
								id="exampleInputEmail1" aria-describedby="emailHelp" />
						</div>
						<div class="form-group ml-3">
							<label for="exampleInputEmail1">Dicription</label>
							<form:textarea path="dicription" type="text" rows="4"
						...
						<div class="form-group ml-3">
							...
							<form:input path="category.id" type="text" class="form-control "
								id="exampleInputEmail1" aria-describedby="emailHelp" />
						</div>
						...
						<div class="ml-3">
							...
							<button formaction="/product/clear" class="btn btn-secondary">Reset</button>
