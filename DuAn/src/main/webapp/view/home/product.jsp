...
<body>
    ...
    <div class="header-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                <a style="display: ${role?'bock':'none'}" href="/admin/home/index" class="btn" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-user"></i> Admin Ustora
                </a>
                </div>
        ...
        <div class="row">
            ...
            <div class=" col-md-2 text-center">
                <li class="taikhoan nav-item dropdown justify-content-end mr-3 pr-3 mt-4">
                    <a class="nav-link text-dark mr-3 pr-3" href="/cart/view" role="button" aria-haspopup="true" aria-expanded="false"> <i class="fas fa-shopping-cart">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light p-0  ">
        ...
        <div class="collapse navbar-collapse" id="navbarMenu">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item pl-4 pr-4"><a class="nav-link text-dark" href="/products">SẢN PHẨM</a></li>
        ...
        <div class="container">
            ...
            <div class="dropdown">
                ...
                <div style="width: 250px;" class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="/products">Điện thoại</a>
                    <a class="dropdown-item" href="/products/laptop">Laptop</a>
                    <a class="dropdown-item" href="/products/phukien">Phụ kiện</a>
                </div>
            </div>
            <!--  -->
            <div class="row">
                    ...
                    <div class="sanpham">
                        <div class="sanpham_image">
                            ...
                            <div class="product-hover">
                                <a href="/cart/add/${i.id}" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                <a href="/detailshop/${i.id}" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                            </div>
                        </div>
